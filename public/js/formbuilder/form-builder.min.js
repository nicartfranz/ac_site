    ...
    !(function (e) {
            ...
            var s = function (e, t) {
                ...
                x = function (e) {
                    for (var t = [], r = 0; r < e.length; r++) {
                        var n = i({}, w(e[r]), { label: e[r].textContent });
                        t.push(n);
                    }
                    return t;
                },
            ...
            var l = (function () {
                ...
                (e.register = function (t, r, n) {
                    ...
                    for (i = a ? i : i[Symbol.iterator](); ; ) {
                        ...
                        var u = s;
                        -1 === u.indexOf(".") ? (e.classRegister[o + u] = r) : e.error("Ignoring type " + u + ". Cannot use the character '.' in a type name.");
                    }
                }),
        ...
        function (e, t) {
            ...
            e.exports = (function (e) {
                ...
                function (e, t, r) {
                    ...
                    function c(e, t) {
                        if (null != e)
                            if (("object" !== (void 0 === e ? "undefined" : n(e)) && (e = [e]), l(e))) for (var r = 0, o = e.length; r < o; r++) t.call(null, e[r], r, e);
                                ...
                                (e.prototype.get = function (e, t) {
                                    ...
                                    if (r) {
                                        var o = r.match(/\{[^}]+?\}/g),
                                            i = void 0;
                                        if (t && o)
                                            if ("object" === (void 0 === t ? "undefined" : n(t))) for (var a = 0; a < o.length; a++) (i = o[a].substring(1, o[a].length - 1)), (r = r.replace(this.makeSafe(o[a]), t[i] || ""));
                    ...
                    (n.prototype = new Error()),
                        ...
                        (e.exports = function (e) {
                            for (var t, r, o = String(e), i = "", a = 0, l = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/="; o.charAt(0 | a) || ((l = "="), a % 1); i += l.charAt(63 & (t >> (8 - (a % 1) * 8)))) {
                                if ((r = o.charCodeAt((a += 0.75))) > 255) throw new n();
                                t = (t << 8) | r;
                            }
                            return i;
                        });
        ...
        function (e, t, r) {
            ...
            var i = {
                ...
                l = { location: "https://formbuilder.online/assets/lang/" },
                s = {};
        },
        function (e, t, r) {
            r.d(t, "d", function () {
        ...
        function (e, t, r) {
            ...
            var l = (function (e) {
                ...
                return (
                    (r = e),
                    ((t = u).prototype = Object.create(r.prototype)),
                    ...
                    (u.register = function (e, t) {
                        ...
                        for (o = a ? o : o[Symbol.iterator](); ; ) {
                            ...
                            if (!e[f]) {
                                ...
                                (d = c.datatype ? c.datatype : f + "-" + Math.floor(9e3 * Math.random() + 1e3)), (u.customRegister[d] = jQuery.extend(c, { type: f, class: p }));
                            }
                                ...
                                var r = t.target.nextSibling.nextSibling,
                                    ...
                                    i = new Map([
                                        ...
                                        [
                                            ...
                                            function () {
                                                o
                                                    ? ((t.target.value = o.innerHTML), (n.value = o.getAttribute("value")), "none" === r.style.display ? e.showList(r, o) : e.hideList(r))
                                                    : e.config.requireValidOption && (e.isOptionValid(r, t.target.value) || ((t.target.value = ""), (t.target.nextSibling.value = ""))),
                                                    t.preventDefault();
                                            },
                                        ],
                                        [
                    ...
                    (c.onRender = function (t) {
                        if (this.config.userData) {
                            ...
                            if (
                                ...
                                return this.config.requireValidOption ? void 0 : void r.prev().val(this.config.userData[0]);
                        ...
                        if (((u.multiple || "checkbox-group" === i) && (u.name = u.name + "[]"), "checkbox-group" === i && u.required && (this.onRender = this.groupRequired), delete u.title, r)) {
                            ...
                            for (var d = 0; d < r.length; d++) {
                                ...
                                if (((v.id = u.id + "-" + d), (v.selected && !o) || delete v.selected, void 0 !== n && v.value === n && (v.selected = !0), f)) {
                                    ...
                                    var k = this.markup("div", j, { className: x });
                                    e.push(k);
                                }
                            }
                            if (!f && l) {
                                var q = { id: u.id + "-other", className: u.className + " other-option", value: "" },
                                    C = "formbuilder-" + c;
                                a && (C += "-inline");
                                ...
                                var N = {
                                    ...
                                    T = this.markup("label", S, { for: E.id }),
                                    D = this.markup("div", [L, T], { className: C });
                                e.push(D);
                            }
                        }
                                    ...
                                    callbacks: {
                                        onError: function (r, n, o) {
                                            ...
                                            var i = e("<div />")
                                                    ...
                                                    .html("<span>Error processing upload: <b>" + n + "</b>.<br />Reason: " + o + "</span>")
                                        ...
                                        onStatusChange: function (e, n, o) {
                                            ...
                                            return r.val(i.join(", ")), { id: e, oldStatus: n, newStatus: o };
                                        },
                                    },
                ...
                return (
                    (o.configure = function () {
                        var e = { modules: { toolbar: [[{ header: [1, 2, !1] }], ["bold", "italic", "underline"], ["code-block"]] }, placeholder: this.config.placeholder || "", theme: "snow" },
                            ...
                            r = t[0],
                            n = t[1];
                        Object.assign(this, j({}, { js: "//cdn.quilljs.com/1.2.4/quill.js", css: "//cdn.quilljs.com/1.2.4/quill.snow.css" }, {}, r)), (this.editorConfig = j({}, e, {}, n));
                    }),
                    (o.build = function () {
                        var e = this.config,
                            t =
        ...
        function (e, t, r) {
            ...
            e.exports = function (e, t, r) {
                ...
                return o(r) && ((i = "leading" in r ? !!r.leading : i), (a = "trailing" in r ? !!r.trailing : a)), n(e, t, { leading: i, maxWait: t, trailing: a });
            };
        },
        function (e, t, r) {
            var n = r(17);
        ...
        function (e, t, r) {
            ...
            e.exports = function (e, t, r) {
                ...
                return (
                    (t = i(t) || 0),
                    n(r) && ((b = !!r.leading), (c = (h = "maxWait" in r) ? a(i(r.maxWait) || 0, t) : c), (g = "trailing" in r ? !!r.trailing : g)),
                    (O.cancel = function () {
        ...
        function (t, r, n) {
                    ...
                    return (
                        ...
                        (r.beforeStop = function (e, t) {
                            ...
                            (this.stopIndex = t.placeholder.index() - 1),
                                !r.sortableControls && t.item.parent().hasClass("frmb-control") && o.push(!0),
                                r.prepend && o.push(0 === this.stopIndex),
                                r.append && o.push(this.stopIndex + 1 === n),
                                (this.doCancel = o.some(function (e) {
                                    return !0 === e;
                                }));
                        }),
                            ...
                            return (
                                n.each(function (t) {
                                    var o = e(n[t]),
                                        ...
                                        a = { label: e(".option-label", o).val(), value: e(".option-value", o).val() };
                        ...
                        (r.updatePreview = function (t) {
                            ...
                            if (!n.includes("input-control")) {
                                ...
                                i.match(r.optionFieldsRegEx) &&
                                    ((s.values = []),
                                    (s.multiple = e('[name="multiple"]', o).is(":checked")),
                                    e(".sortable-options li", o).each(function (t, r) {
                                        var n = { selected: e(".option-selected", r).is(":checked"), value: e(".option-value", r).val(), label: e(".option-label", r).val() };
                                        s.values.push(n);
                                    })),
                                    ((s = Object(p.z)(s, !0)).className = this.classNames(o, s)),
                                    t.data("fieldData", s);
                        ...
                        (r.disabledTT = function (e) {
                            ...
                            Object(p.i)(t, function (e) {
                                ...
                                if (n) {
                                    var o = Object(p.p)("p", n, { className: "frmb-tt" });
                                    r.appendChild(o),
                        ...
                        (r.closeConfirm = function (e, t) {
                            e || (e = document.getElementsByClassName("form-builder-overlay")[0]),
                                ...
                                document.dispatchEvent(f.a.modalClosed);
                        }),
                        ...
                        (r.showOverlay = function () {
                            var e = this,
                                t = Object(p.p)("div", null, { className: "form-builder-overlay" });
                            return (
                        ...
                        (r.confirm = function (e, t, r, n) {
                            ...
                            var o = this,
                                i = c.a.current,
                                a = o.showOverlay(),
                                l = Object(p.p)("button", i.yes, { className: "yes btn btn-success btn-sm" }),
                                s = Object(p.p)("button", i.no, { className: "no btn btn-danger btn-sm" });
                            (s.onclick = function () {
                                o.closeConfirm(a);
                            }),
                                (l.onclick = function () {
                            ...
                            var u = Object(p.p)("div", [s, l], { className: "button-wrap" });
                            n = "form-builder-dialog " + n;
                            var f = Object(p.p)("div", [e, u], { className: n });
                            if (r) f.classList.add("positioned");
                            else {
                                var d = document.documentElement;
                                (r = { pageX: Math.max(d.clientWidth, window.innerWidth || 0) / 2, pageY: Math.max(d.clientHeight, window.innerHeight || 0) / 2 }), (f.style.position = "fixed");
                            }
                        ...
                        (r.dialog = function (e, t, r) {
                            ...
                            var i = Object(p.p)("div", e, { className: r });
                            return (
                                t ? i.classList.add("positioned") : ((t = { pageX: Math.max(n, window.innerWidth || 0) / 2, pageY: Math.max(o, window.innerHeight || 0) / 2 }), (i.style.position = "fixed")),
                                (i.style.left = t.pageX + "px"),
                                (i.style.top = t.pageY + "px"),
                                document.body.appendChild(i),
                                document.dispatchEvent(f.a.modalOpened),
                                -1 !== r.indexOf("data-dialog") && document.dispatchEvent(f.a.viewData),
                                i
                            );
                        }),
                        ...
                        (r.removeAllFields = function (e, t) {
                            ...
                            if (
                                ...
                                l.some(function (e) {
                                    return !0 === e;
                                }) || (e.classList.add("empty"), (e.dataset.content = n.getStarted)),
                                t)
                            ) {
                        ...
                        (r.setFieldOrder = function (t) {
                            ...
                            return (
                                ...
                                n && n.setItem("fieldOrder", o.stringify(i)),
                                i
                            );
                        }),
                        ...
                        (r.toggleEdit = function (t, r) {
                            ...
                            return (
                                ...
                                r ? (i.slideToggle(250), o.slideToggle(250)) : (i.toggle(), o.toggle()),
                                this.updatePreview(e(n)),
                                n.classList.contains("editing")
                                    ? ((this.formBuilder.currentEditPanel = o[0]), m.a.opts.onOpenFieldEdit(o[0]), document.dispatchEvent(f.a.fieldEditOpened))
                                    : (m.a.opts.onCloseFieldEdit(o[0]), document.dispatchEvent(f.a.fieldEditClosed)),
                                n
                            );
                        }),
                            ...
                            e(window).scroll(function (t) {
                                ...
                                if (l > a) {
                                    var c = Object.assign({ position: "sticky" }, u),
                                        ...
                                        b = d.top + d.height,
                                        h = p === b && f.top > l;
                                    p > b && f.top !== d.top && o.css({ position: "absolute", top: "auto", bottom: 0, right: 0, left: "auto" }), (p < b || h) && o.css(c);
                        ...
                        (r.showData = function () {
                            ...
                            var t = Object(p.p)("code", e, { className: "formData-" + m.a.opts.dataType });
                        ...
                        (r.removeField = function (t, r) {
                            ...
                            if (!t || !l) {
                                ...
                                m.a.opts.notify.warning("fieldID required to remove specific fields."),
                                    ...
                                    m.a.opts.notify.warning("Available IDs: " + s.join(", ")),
                                    (t = i.lastChild.id);
                            }
                            var u = e(l);
                        ...
                        (r.editorUI = function (e) {
                            var t = this.d,
                                r = this.data,
                                n = e || r.formID;
                            (t.editorWrap = Object(p.p)("div", null, { id: r.formID + "-form-wrap", className: "form-wrap form-builder " + Object(p.q)() })),
                                (t.stage = Object(p.p)("ul", null, { id: n, className: "frmb stage-wrap " + r.layout.stage })),
                                (t.controls = Object(p.p)("ul", null, { id: n + "-control-box", className: "frmb-control" }));
                            var o = this.formActionButtons();
                            t.formActions = Object(p.p)("div", o, { className: "form-actions btn-group" });
                        }),
                        ...
                        (r.processOptions = function (e) {
                            ...
                            return (
                                (o.fields = o.fields.concat(n)),
                                (o.disableFields = o.disableFields.concat(
                                    n.map(function (e) {
                                        var t = e.type;
                                        return t && t;
                                    })
                                )),
                                "xml" === o.dataType && (o.disableHTMLLabels = !0),
                                (m.a.opts = Object.assign({}, { actionButtons: a }, { fieldEditContainer: i }, o)),
                                m.a.opts
                            );
                        }),
                        (r.input = function (e) {
                        ...
                        return (
                            ...
                            (t.setupControls = function () {
                                ...
                                for (var o = 0; o < r.length; o++) {
                                    ...
                                    var f = Object(p.p)("li", Object(p.p)("span", u), { className: c + " input-control input-control-" + o });
                                ...
                                t.inputSets.length &&
                                    t.inputSets.forEach(function (t, r) {
                                        ...
                                        var i = Object(p.p)("li", o, { className: "input-set-control input-set-" + r });
                            ...
                            (t.orderFields = function (e) {
                                ...
                                return (
                                    window.sessionStorage && (r.sortableControls ? (t = window.sessionStorage.getItem("fieldOrder")) : window.sessionStorage.removeItem("fieldOrder")),
                                    t
                                        ? ((t = window.JSON.parse(t)),
                                          (t = Object(p.A)(t.concat(e))),
                            ...
                            (t.appendControls = function () {
                                ...
                                Object(a.b)(this.dom),
                                    this.orderFields(this.controlList).forEach(function (r) {
            ...
            var O = function (e, t, r) {
                    ...
                    C.sortable({
                        ...
                        e.allowStageSort || C.sortable("disable"),
                        E.sortable({
                            helper: "clone",
                            opacity: 0.9,
                            connectWith: C,
                    ...
                    var N = function (t) {
                        ...
                        L = r(h.editorWrap),
                        S = j("div", h.controls, { id: b.formID + "-cb-wrap", className: "cb-wrap " + b.layout.controls });
                    e.showActionButtons && S.appendChild(h.formActions),
                        L.append(h.stage, S),
                        "textarea" !== t.type ? r(t).append(L) : r(t).replaceWith(L),
                        r(h.controls).on("click", "li", function (e) {
                            var t = e.target,
                                n = r(t).closest("li");
                    ...
                    var T = function (t, n) {
                            ...
                            if (t instanceof jQuery)
                                if (((o.type = t[0].dataset.type), o.type)) {
                                    ...
                                    n ||
                                        (o.values = t.children().map(function (e, t) {
                            ...
                            u && (o.style = u[1]),
                                ...
                                e.onAddField(b.lastID, o),
                                Y(o, n),
                                h.stage.classList.remove("empty");
                        },
                        D = function (t) {
                            var n, o;
                            (t = O.getData(t)) && t.length
                                ? (t.forEach(function (e) {
                                      return T(Object(p.z)(e));
                                  }),
                                  h.stage.classList.remove("empty"))
                                : e.defaultFields && e.defaultFields.length
                                ? (e.defaultFields.forEach(function (e) {
                                      return T(e);
                                  }),
                                  h.stage.classList.remove("empty"))
                                : e.prepend || e.append || (h.stage.classList.add("empty"), (h.stage.dataset.content = c.a.get("getStarted"))),
                                (n = []),
                                (o = function (t) {
                                    return j("li", e[t], { className: "disabled-field form-" + t });
                                }),
                                e.prepend && !r(".disabled-field.form-prepend", h.stage).length && (n.push(!0), C.prepend(o("prepend"))),
                                e.append && !r(".disabled-field.form-.append", h.stage).length && (n.push(!0), C.append(o("append"))),
                                O.disabledTT(h.stage),
                                n.some(function (e) {
                                    return !0 === e;
                                }) && h.stage.classList.remove("empty"),
                                O.save();
                        ...
                        B = function (e) {
                            var t,
                                ...
                                n = e.values,
                                o = e.name,
                                i = [j("a", c.a.get("addOption"), { className: "add add-opt" })],
                                a = [j("label", c.a.get("selectOptions"), { className: "false-label" })],
                            ...
                            if (n && n.length)
                                ...
                                var u = (t = s.map(function (e) {
                                    return (t = "" + c.a.get("optionCount", e)), (n = { label: t, value: Object(p.m)(t) }), "autocomplete" !== r && (n.selected = !1), n;
                                    var t, n;
                                }))[0];
                                u.hasOwnProperty("selected") && "radio-group" !== r && (u.selected = !0);
                            }
                            var f = j("div", i, { className: "option-actions" }),
                                d = j(
                                    "ol",
                                    t.map(function (e) {
                                        return W(o, e, l);
                                ...
                                m = j("div", [d, f], { className: "sortable-options-wrap" });
                            return a.push(m), j("div", a, { className: "form-group field-options" }).outerHTML;
                        },
                        R = function (t) {
                            var r,
                                n = t.type,
                                ...
                                a = {
                                    ...
                                    toggle: function () {
                                        return P("toggle", t, { first: c.a.get("toggle") });
                                    },
                                    inline: function () {
                                    ...
                                    other: function () {
                                        return P("other", t, { first: c.a.get("enableOther"), second: c.a.get("enableOtherMsg") });
                                    },
                                    options: function () {
                                        return B(t);
                                    },
                                    requireValidOption: function () {
                                        return P("requireValidOption", t, { first: " ", second: c.a.get("requireValidOption") });
                                    },
                                    multiple: function () {
                                        var e = {
                                        ...
                                        n = {
                                            ...
                                            boolean: function (e, r) {
                                                var n,
                                                    o = !1;
                                                return (
                                                    t.hasOwnProperty(e) ? (o = t[e]) : (r.hasOwnProperty("value") || r.hasOwnProperty("value")) && (o = r.value || r.checked || !1),
                                                    P(
                                                        e,
                                                        (function (e) {
                                                            for (var t = 1; t < arguments.length; t++) {
                    ...
                    function M(e, t) {
                        var r = t.class,
                            ...
                            i = { id: e + "-" + b.lastID, title: o.description || o.label || e.toUpperCase(), name: e, type: o.type || "text", className: ["fld-" + e, (r || n || "").trim()] },
                            a = '<label for="' + i.id + '">' + (l[e] || "") + "</label>";
                        return (
                            ["checkbox", "checkbox-group", "radio-group"].includes(i.type) || i.className.push("form-control"),
                            (i = Object.assign({}, o, i)),
                            '<div class="form-group ' + e + '-wrap">' + a + ('<div class="input-wrap">' + ("<input " + Object(p.b)(i) + ">") + "</div>") + "</div>"
                        );
                    }
                    function I(e, t) {
                        var r = t.multiple,
                            ...
                            d = { id: e + "-" + b.lastID, title: u.description || o || e.toUpperCase(), name: e, className: ("fld-" + e + " form-control " + (a || s || "")).trim() };
                        r && (d.multiple = !0);
                    ...
                    var P = function (e, t, r) {
                            void 0 === r && (r = {});
                            var n = function (t) {
                                    return j("label", t, { for: e + "-" + b.lastID }).outerHTML;
                                },
                            ...
                            return (
                                r.first && i.push(n(r.first)),
                                r.second && a.push(" ", n(r.second)),
                                r.content && a.push(r.content),
                                (a = j("div", a, { className: "input-wrap" }).outerHTML),
                                j("div", i.concat(a), { className: "form-group " + e + "-wrap" }).outerHTML
                            );
                        },
                        z = function (e) {
                            var t = "";
                            ...
                            return (
                                (t += O.input({ value: e || "default", type: "hidden", className: "btn-style" }).outerHTML),
                                (t += '<div class="btn-group" role="group">'),
                                m.d.btn.forEach(function (r) {
                                    var n = ["btn-xs", "btn", "btn-" + r];
                                    e === r && n.push("selected");
                                    var o = j("button", c.a.get("styles.btn." + r), { value: r, type: "button", className: n.join(" ") }).outerHTML;
                                    t += o;
                                }),
                                (t = j("div", [r, (t += "</div>")], { className: "form-group style-wrap" })).outerHTML
                            );
                        },
                        U = function (e, t) {
                            var r = t.class,
                                ...
                                a = c.a.get(e) || e,
                                l = { type: "number", value: i, name: e, placeholder: c.a.get("placeholder." + e), className: ("fld-" + e + " form-control " + (r || n || "")).trim(), id: e + "-" + b.lastID },
                                s = O.input(Object(p.z)(l)).outerHTML;
                            return j("div", ['<label for="' + l.id + '">' + a + "</label>", '<div class="input-wrap">' + s + "</div>"], { className: "form-group " + e + "-wrap" }).outerHTML;
                        },
                        H = function (e, t, r) {
                            var n = r.map(function (r, n) {
                                ...
                                a = j("label", i, { for: o.id }),
                                s = j("select", n, o),
                                u = j("div", s, { className: "input-wrap" });
                            return j("div", [a, u], { className: "form-group " + o.name + "-wrap" }).outerHTML;
                        },
                        Q = function (t, r, n) {
                            void 0 === n && (n = !1);
                            var o = r[t] || "",
                            ...
                            if (
                                ...
                                var f = '<div class="input-wrap">' + l + "</div>",
                                    d = n ? "none" : "block";
                                "value" === t && (d = r.subtype && "quill" === r.subtype && "none"), (l = j("div", [u, f], { className: "form-group " + t + "-wrap", style: "display: " + d }));
                            }
                            return l.outerHTML;
                        },
                        V = function (e) {
                            ...
                            return (
                                ...
                                r.some(function (e) {
                                    return !0 === e;
                                }) || (n = P("required", e, { first: c.a.get("required") })),
                                n
                            );
                        },
                        Y = function (t, n) {
                            ...
                            var s = e.disabledFieldButtons[i] || t.disabledFieldButtons,
                                u = [
                                    j("a", null, { type: "remove", id: "del_" + b.lastID, className: "del-button btn icon-cancel delete-confirm", title: c.a.get("removeMessage") }),
                                    j("a", null, { type: "edit", id: b.lastID + "-edit", className: "toggle-form btn icon-pencil", title: c.a.get("hide") }),
                                    j("a", null, { type: "copy", id: b.lastID + "-copy", className: "copy-button btn icon-copy", title: c.a.get("copyButtonTooltip") }),
                                ];
                            s &&
                                Array.isArray(s) &&
                            ...
                            var f = [j("div", u, { className: "field-actions" })];
                            f.push(j("label", Object(p.t)(a), { className: "field-label" })), f.push(j("span", " *", { className: "required-asterisk", style: t.required ? "display:inline" : "" }));
                            var d = { className: "tooltip-element", tooltip: t.description, style: t.description ? "display:inline-block" : "display:none" };
                            f.push(j("span", "?", d)), f.push(j("div", "", { className: "prev-holder" }));
                            var m = j("div", [R(t), j("a", c.a.get("close"), { className: "close-field" })], { className: "form-elements" }),
                                g = j("div", m, { id: b.lastID + "-holder", className: "frm-holder", dataFieldId: b.lastID });
                            (o.currentEditPanel = g), f.push(g);
                            var v = j("li", f, { class: i + "-field form-field", type: i, id: b.lastID }),
                                y = r(v);
                            y.data("fieldData", { attrs: t }),
                                void 0 !== O.stopIndex ? r("> li", h.stage).eq(O.stopIndex).before(y) : C.append(y),
                                r(".sortable-options", y).sortable({
                                    update: function () {
                                        return O.updatePreview(y);
                                    },
                                }),
                                O.updatePreview(y),
                                e.typeUserEvents[i] && e.typeUserEvents[i].onadd && e.typeUserEvents[i].onadd(v),
                                n && (e.editOnAdd && (O.closeAllEdit(), O.toggleEdit(b.lastID, !1)), v.scrollIntoView && e.scrollToFieldOnAdd && v.scrollIntoView({ behavior: "smooth" }));
                        },
                        W = function (e, t, r) {
                            var n = { selected: r ? "checkbox" : "radio" },
                            ...
                            for (var a = o.length - 1; a >= 0; a--) {
                                ...
                                if (t.hasOwnProperty(l)) {
                                    var s = { type: n[l] || "text", className: "option-" + l, value: t[l], name: e + "-option" };
                                    (s.placeholder = c.a.get("placeholder." + l) || ""), "selected" === l && !0 === t.selected && (s.checked = t.selected), i.push(j("input", null, s));
                                }
                            }
                            var u = { className: "remove btn icon-cancel", title: c.a.get("removeMessage") };
                    ...
                    C.on(
                        ...
                        C.on("click touchstart", ".remove", function (t) {
                            ...
                            t.preventDefault(),
                                o.querySelector(".sortable-options").childNodes.length <= 2 && !i.includes("checkbox")
                    ...
                    if (
                        (C.on("change", [".prev-holder input", ".prev-holder select", ".prev-holder textarea"].join(", "), function (e) {
                            var t;
                            ...
                            var n = r(t.target).parent().parent("li"),
                                o = (function (t) {
                                    ...
                                    return (
                                        ...
                                        a.attr("name", i),
                                        a.addClass("cloned"),
                                        r(".sortable-options", a).sortable(),
                                        e.typeUserEvents[o] && e.typeUserEvents[o].onclone && e.typeUserEvents[o].onclone(a[0]),
                                        a
                                    );
                                })(n);
                    ...
                    return (
                        document.dispatchEvent(f.a.loaded),
                        (o.actions = {
                            ...
                            setLang: function (e) {
                                c.a.setCurrent.call(c.a, e).then(function () {
                                    (h.stage.dataset.content = c.a.get("getStarted")),
                                        k.init(),
                                        h.empty(h.formActions),
                                        O.formActionButtons().forEach(function (e) {
