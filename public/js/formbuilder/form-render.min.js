            ...
            var l = function (e, t) {
                ...
                w = function (e) {
                    for (var t = [], n = 0; n < e.length; n++) {
                        var r = i({}, x(e[n]), { label: e[n].textContent });
                        t.push(r);
                    }
                    return t;
                },
                        ...
                        if (((u.multiple || "checkbox-group" === i) && (u.name = u.name + "[]"), "checkbox-group" === i && u.required && (this.onRender = this.groupRequired), delete u.title, n)) {
                            ...
                            if (!d && s) {
                                ...
                                var S = {
                                    ...
                                    L = this.markup("label", T, { for: E.id }),
                                    D = this.markup("div", [R, L], { className: A });
                                e.push(D);
                            }
                        }
